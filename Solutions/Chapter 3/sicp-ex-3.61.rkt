...
(define (constant-serie n)
  (cons-stream n (constant-serie n)))

; 1/(1-x) = 1 + x + x^2 + x^3 + x^4 + ...
; 1 - x = 1 - x
(display-inf-stream (invert-unit-series (constant-serie 1)) 0 20)

;sec x
;https://math.stackexchange.com/questions/2616561/taylor-series-for-secx
(display-inf-stream (invert-unit-series cosine-series) 0 20)
