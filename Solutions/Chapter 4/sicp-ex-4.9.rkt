    ...
    (define (execute-application proc args)
      (cond ((primitive-procedure? proc) (apply-primitive-procedure proc args))
            ((compound-procedure? proc)
             ((procedure-body proc)
              (extend-environment
               (make-frame (map make-binding (procedure-parameters proc) args))
...
(define (primitive-procedure-names) (frame-variables primitive-procedures))
